    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between hidden md:flex">
      <div>
        ...
        <nav class="px-4 space-y-1">
          <a href="<?= BASEURL; ?>/admin" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-medium <?= ($data['menu_aktif'] == 'dashboard') ? 'bg-secondary text-primary' : 'text-gray-600 hover:bg-gray-50' ?> transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
            </svg>
            <span>Dashboard</span>
          </a>
          <a href="#" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <header class="flex items-center justify-between px-10 pt-10 pb-4 z-10">
        ...
        <div class="flex items-center space-x-6">
          <div class="relative hidden lg:block">
            ...
            <input type="text" placeholder="Search..." class="bg-white shadow-sm border border-gray-100 text-sm rounded-full pl-11 pr-4 py-2.5 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary w-72 transition">
          </div>
          <button class="relative text-gray-400 hover:text-primary transition bg-white p-2.5 rounded-full shadow-sm border border-gray-100">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
